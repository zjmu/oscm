define({ "api": [
  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "Request_Example:",
          "content": "GET: /improvementPlan?year=2019 && month = 5\n<p>\nRequest Header 如下\nContent-Type:application/json;charset=utf-8\nAuthorization:Bearer {jwt}\n<p>",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "PUT",
    "url": "/reduceTarget_monthValue",
    "title": "更改指定项目月降低目标",
    "name": "updateReduceTarget_monthValue____________",
    "group": "ReduceTarget",
    "parameter": {
      "fields": {
        "Parameter": [
    ...
    "sampleRequest": [
      {
        "url": "http://oscm.xmiss.top/oscm_new/reduceTarget_monthValue"
      }
    ]
  },
  {
    "type": "PUT",
    "url": "/reduceTarget_yearPercent",
    "title": "更改指定项目年降低目标比例",
    "name": "updateReduceTarget_yearPercent______________",
    "group": "ReduceTarget",
    "parameter": {
      "fields": {
        "Parameter": [
    ...
    "sampleRequest": [
      {
        "url": "http://oscm.xmiss.top/oscm_new/reduceTarget_yearPercent"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://oscm.xmiss.top/oscm_new/reduceTarget_yearValue"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://oscm.xmiss.top/oscm_new/reduceTargets_yearValue"
      }
    ]
  },
  {
